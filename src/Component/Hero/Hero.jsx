      ...
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={6} xl={7}>
            ...
            <h1>
              Hey <WavingHandIcon sx={{ fontSize: 40, color: yellow[500] }} />,
            </h1>
            <h2>
              _<span className="wrap">{text}</span>
            </h2>
            <br />
            <p>
              {" "}
              I&apos;m Digwijay, a dedicated Full Stack Web Developer focused on
              Angular development. I specialize in crafting seamless web
